...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../src/plugins/beforeInstallPrompt.client.js").default> &
  ...
  InjectionType<typeof import("../../node_modules/nuxt-site-config/dist/runtime/nuxt/plugins/i18n.server.js").default> &
  ...
  InjectionType<typeof import("../../src/plugins/copy.js").default> &
  InjectionType<typeof import("../../src/plugins/crypto.js").default> &
  InjectionType<typeof import("../../src/plugins/ga4.js").default> &
  InjectionType<typeof import("../../src/plugins/request.js").default> &
  InjectionType<typeof import("../../src/plugins/routerHistory.js").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt-site-config:init' | 'beforeInstallPromptPlugin' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch' | 'vite-pwa:nuxt:pwa-icons-plugin' | 'nuxt-site-config:i18n' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin'
  }
}
